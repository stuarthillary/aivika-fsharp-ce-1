...
module ExperimentExtensions =
    ...
    type Experiment with
        ...
        member x.RenderHtml (model: Simulation<ResultSet>, providers: IExperimentProvider<HtmlDocument> list) =
            async {
                ...
                let ctx = ExperimentContext (x, dir, resolve, doc)

                doc.Head.Add("title").Text(x.Title) |> ignore
                ...
                doc.Body.Add("h1").Text(x.Title) |> ignore
                ...
                doc.Body.Add("p").Text("Automatically generated by Aivika Simulation Framework") |> ignore
                ...
                doc.WriteToFile(Path.Combine (dir, "index.html"))
